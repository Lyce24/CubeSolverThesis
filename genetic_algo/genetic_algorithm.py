...
class Fitness:
    def __init__(self, scrambled_str, model, nnet):
        self.scrambled_str = scrambled_str
        self.model = model
        self.nnet = nnet
        
    def compute_fitness_drl(self, individual):
        """Compute the fitness of an individual solution."""
        cube = FaceCube()
        cube.from_string(self.scrambled_str)
        ...
        if cube.is_solved():
            ...
            output = self.nnet(input_tensor)
            return -output.item()
        
    def compute_fitness_v1(self, individual):
        """Compute the fitness of an individual solution."""
        cube = FaceCube()
        cube.from_string(self.scrambled_str)
    ...
    def compute_fitness_v2(self, individual):
        """Compute the fitness of an individual solution."""
...
if __name__ == "__main__":
    ...
    #     genetic_algorithm(scramble_cube.to_string(), "resnet", "plot")