...
# # Example usage:
# cube = FaceCube()
# cube.move_list(cube.convert_move("D B2 F2 D L2 U L2 U L2 D2 L' D' L D2 R U2 F' U L B"))
...
def compute_fitnesses(population):
    """Compute the fitness for each individual in the population in parallel."""
    scores = []
    with concurrent.futures.ThreadPoolExecutor() as executor:
        futures = [executor.submit(compute_fitness, scrambled_str, individual) for individual in population]
